...
export const INITIAL_REDUCER = new InjectionToken('Token ngrx/store/reducer');
export const INITIAL_STATE = new InjectionToken(
  'Token ngrx/store/initial-state'
);

export const _INITIAL_REDUCER = new InjectionToken('Token _ngrx/store/reducer');
export const _INITIAL_STATE = new InjectionToken(
  'Token _ngrx/store/initial-state'
);
...
export function provideStore(_reducer: any, _initialState?: any): any[] {
  return [
    ...
    {
      provide: Store,
      useFactory: _storeFactory,
      deps: [Dispatcher, Reducer, State]
    },
    {
      provide: Reducer,
      useFactory: _reducerFactory,
      deps: [Dispatcher, INITIAL_REDUCER]
    },
    {
      provide: State,
      useFactory: _stateFactory,
